...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{pic/drawing.png}
...
\[ C \approx 1.014 C_0  = 1.014 \cdot 20 = 20.28 \; \text{мм} \]
Тогда площадь чистовой заготовки:
\[ F_{\text{к}} = C^2 = 411.278 \; \text{мм}^2 \]
Размеры калибра расчитываются по формулам, представленным в \cite{mainbook}
\[ H_1' = B_{\text{к}} = \sqrt{2} C_1 = \sqrt{2} \cdot 20.28 = 28.68 \; \text{мм} \]
\[ r \cong (0.1 \ldots 0.2) \cdot C_1 = (0.1 \ldots 0.2) \cdot 20.28 = 2.028 \ldots 4.056 \approx 3 \; \text{мм} \]
\[ H_1 = \sqrt{2} C_1  - 0.83 \cdot r = \sqrt{2} \cdot 20.28 - 0.83 \cdot 3 = 26.190 \; \text{мм} \]
\begin{equation}\label{b:pr:kvadrata}
 B_{\text{пр}} = B_{\text{к}} - S 
\end{equation}
...
\[ S = (0.005\ldots0.008) D = (0.005 \ldots 0.008) \cdot 300 = (1.5\ldots2.4) \approx 2 \; \text{мм} \]
Тогда из уравнения \ref{b:pr:kvadrata}:
\[ B_{\text{вр}} = 28.68 - 2 = 26.68 \; \text{мм} \]
\[ r_1 \cong (0.10 \ldots 0.15)H_1' = (0.10 \ldots 0.15) \cdot 28.68 = (2.868 \ldots 4.302) = 3 \; \text{мм} \]
\[ \Pi \approx 2 H_1 \sqrt{2} = 2 \cdot 26.190 \cdot \sqrt{2} = 74.077 \; \text{мм} \]
Глубина вреза в валки:
\[ H_{\text{вр}} = \dfrac{H_1' - s}{2} = \dfrac{28.68 - 2}{2} = 13.34 \; \text{мм} \]

\section{Расчёт формоизменения полосы в проходах 1 и 2}

Площадь исходного сечения:
\[ F_{\text{исх}} = \dfrac{\pi d_{\text{к}}^2}{4} = \dfrac{3.1415 \cdot 38^2}{4} = 1134.082 \; \text{мм}^2 \]

Периметр исходного сечения:
\[ \Pi_{\text{исх}} = \pi d = 3.1415 \cdot 38 = 119.377 \]

Тогда суммарный коэффициент вытяжки:
\[ \lambda_{\Sigma} = \dfrac{F_{\text{исх}}}{F_{\text{к}}} =\dfrac{1134.082}{411.278} = 2.757 \]

Средний коэффициент вытяжки за один проход:
\[ \lambda_{\text{ср}} = \sqrt[4]{\lambda_{\Sigma}} = \sqrt[4]{2.757} = 1.289 \]
...
\[ \lambda_{1-2} = \lambda_{\text{ср}}^2 = 1.289^2 = 1.662 \]
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/NomP15}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/NomP13}
...
\[ F_2 = F_1\cdot \lambda_1 = 411.278 \cdot 1.23 = 505.872 \; \text{мм}^2 \]

%Отсюда высота овальной полосы на входе в чистовой калибр составит:
%\[ H_2 = H_1 \cdot \dfrac{1}{\eta} = 26.190 \cdot 1.25 = 32.738 \; \text{мм} \]

\[ B_2 = \dfrac{1}{\eta_1} \cdot H_1 = 1.25 \cdot 26.190 = 32.738 \; \text{мм} \]

Степень заполнения овального калибра примем $ \delta_2 = 0.85 $, отношение осей $ a_{\text{к}2} $ примем равным отношению осей полосы $ a_{\text{к}2} = 1.7 $

Тогда, согласно \cite{mainbook} высота овальной полосы составит:
\[ H_2 = \sqrt{\dfrac{F_2}{0.6(2.07 - \delta_2 ) (a_{\text{к}} \delta_2 + 0.66 \delta_2 - 0.43)}} \]
\[ H_2 = \sqrt{\dfrac{505.872}{0.6(2.07 - 0.85)(1.7 \cdot 0.85 + 0.66 \cdot 0.85 - 0.43)}} = 20.94 \; \text{мм}  \]

Характеристики калибра расчитываются по формулам:
\begin{eqnarray}
R = H_2 \dfrac{(1 + a_{\text{к}})^2}{4}; \label{eq:r:oval} \\
B_{\text{к}} = H_2 \sqrt{\dfrac{4R}{H_2} - 1}; \label{eq:b:k:oval} \\
B_{\text{вр}} = (H_2 - S) \sqrt{\dfrac{4R}{H_2 - S} - 1}; \label{eq:b:vr:oval} \\
r_1 = (0.10\ldots0.40) \cdot H_2; \label{eq:r:1:oval} \\
\Pi \cong 2 \sqrt{B_1^2 + \dfrac{4}{3} H_2^2}; \label{eq:pi:oval} 
\end{eqnarray}

\[ R = 20.94 \cdot \dfrac{\left(1 + 1.7\right)^2}{4} = 38.163 \; \text{мм} \]
\[ B_{\text{к}} = 20.94 \cdot \sqrt{\dfrac{4 \cdot 38.163}{20.94} - 1} = 52.517 \; \text{мм} \]
\[ B_{\text{вр}} = (20.94 - 2) \cdot \sqrt{\dfrac{4 \cdot 38.163}{20.94 - 2} - 1} = 50.324 \; \text{мм} \]
\[ r_1 = (0.10\ldots0.40) \cdot 20.94 = (2.094\ldots8.376)\approx 5 \; \text{мм} \]
\[ \Pi \cong 2 \cdot \sqrt{52.517^2 + \dfrac{4}{3} \cdot 20.94^2} = 115.632 \; \text{мм} \]

\section{Расчёт формоизменения полосы в калибрах 3 и 4}

Площадь круглой полосы, выходящей из калибра №3, будет равна:
\[ F_3 = F_1 \cdot \lambda_{1-2} = 411.278 \cdot 1.662 = 683.544 \; \text{мм}^2 \]

Примем $ \delta_3 = 0.85 $. Тогда:
\[ H_3 = \sqrt{\dfrac{F_3}{0.785 - 0.667(1 - \delta_3)\sqrt{1 - \delta_3^2}}} = \]
\[ = \sqrt{\dfrac{683.544}{0.785 - 0.667 \cdot(1 - 0.85)\sqrt{1-0.85^2}}}  = 30.552 \; \text{мм} \]

Характеристики калибра расчитываются по формулам:
\begin{eqnarray}
B_{\text{к}} = \dfrac{D}{\cos\left( \gamma \right)};\label{eq:b:k:krug} \\
B_{\text{вр}} = B_{\text{к}} - S \tan\left( \gamma \right);\label{eq:b:vr:krug} \\
r_1 (0.08 \ldots 0.10) D;\label{eq:r:1:krug} \\
\Pi = \pi D;\label{eq:pi:krug} \\
H_{\text{вр}} = \dfrac{H_1 - S}{2}\label{eq:h:vr:krug}
\end{eqnarray}
...
\[ B_{\text{к}} = \dfrac{30.552}{\cos\left(21^{\circ}50'\right)} = 32.913 \; \text{мм} \]
\[ B_{\text{вр}} = 32.913 - 2 \cdot \tan\left(21^{\circ}50'\right) = 32.112 \; \text{мм} \]
\[ r_1 = (0.08\ldots0.10) = 2.444\ldots3.055 \approx 3 \; \text{мм} \]
\[ \Pi = 3.1415 \cdot 30.552 = 95.979 \; \text{мм} \]
\[ H_{\text{вр}} = \dfrac{30.552 - 2}{2} = 14.276 \; \text{мм} \]
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/NomP24}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/NomP25}
...
\[ B_4 = H_3 \cdot \dfrac{1}{\eta_3} = 30.552 \cdot 1.48 = 45.217 \; \text{мм} \]

Примем степень заполнения калибра $ \delta_4 = 0.85 $, отношение сторон $ a_{\text{к} 4} = 1.7 $. Тогда:

Высота полосы на выходе из калибра №4:
\[ H_4 = \sqrt{\dfrac{F_4}{0.6(2.07 - \delta_4 ) (a_{\text{к}} \delta_4 + 0.66 \delta_4 - 0.43)}} \]
\[ H_4 = \sqrt{\dfrac{922.784}{0.6(2.07 - 0.85)(1.7 \cdot 0.85 + 0.66 \cdot 0.85 - 0.43)}} = 28.282 \; \text{мм}  \]
...
\[ R = 28.282 \cdot \dfrac{\left(1 + 1.7\right)^2}{4} = 51.544 \; \text{мм} \]
\[ B_{\text{к}} = 28.282 \cdot \sqrt{\dfrac{4 \cdot 51.544}{28.282} - 1} = 70.939 \; \text{мм} \]
\[ B_{\text{вр}} = (28.282 - 2) \cdot \sqrt{\dfrac{4 \cdot 51.544}{28.282 - 2} - 1} = 68.760 \; \text{мм} \]
\[ r_1 = (0.10\ldots0.40) \cdot 28.282 = 2.828\ldots11.313 = 8 \; \text{мм} \]
\[ \Pi \cong 2 \sqrt{70.939^2 + \dfrac{4}{3} \cdot 28.282^2} = 156.190 \; \text{мм} \]
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{pic/LambdaEta}
...
\begin{tabular}{|c|c|c|c|c|c|}
	...
	\hline 
	$B_{\text{к}}$, мм & - & 70.939 & 32.913 & 52.517 & 28.68 \\ 
	\hline 
	$B_{\text{вр}}$, мм & - & 68.760 & 32.112 & 50.324 & 26.68 \\ 
	\hline 
	$r_1$, мм & - & 8 & 3 & 5 & 3 \\ 
	\hline 
	$r$, мм & - & 3 &  & - & 3 \\ 
	\hline 
	$H_{\text{вр}}$, мм & - & - & 14.276 & - & 13.34 \\ 
	\hline 
	$R$, мм & - & 51.544 & - & 38.163 & -- \\ 
	\hline 
...
\[ v_{\text{вых}} = \dfrac{\pi D_{\text{к}i} n}{60} \]
\[ v_{\text{вх} i} = \dfrac{v_{\text{вых} i}}{\lambda_i} \]
...
\begin{equation}
\sigma_{\text{ф}} = A_1A_2A_3 \sigma_{\text{од}} e^{-m_1t} \varepsilon^{m_2} u^{m3}
\end{equation}

Для стали 12Х18Н9Т:

\[ A_1 A_2 A_3 \sigma_{\text{од}} = 3250 \; \text{МПа}; \; m_1 = 0.0028; \; m_2 = 0.28; \; m_3 = 0.087 \]

Коэффицент трения по формуле Экелунда с поправками Б. П. Бахтинова и М. М. Штернова:
\begin{equation}
\mu_{\text{уст}} = 0.6 k_1 k_2 k_3 (1.05 - 0.0005 T)
\end{equation}
...
%\begin{equation}
%\triangle b = \dfrac{1}{2} \left( l - \dfrac{\triangle h^{\text{пр}}}{2 \mu_{\text{уст}}}\right) \ln\left(\dfrac{h_0^{\text{пр}}}{h_1^{\text{пр}}}\right)
%\end{equation}
...
\begin{equation}
p_{\text{ср}} = \gamma n_{\sigma}' n_{\sigma}'' n_{\sigma}''' n_{\text{в}} n_{\text{к}} \sigma_{\text{ф}}
\end{equation}

Где:
\[ \gamma = \begin{cases}
1.155 &, \dfrac{b_{\text{ср}}}{h_{\text{ср}}} > \dfrac{0.465}{\mu_{\text{уст}}} \\
1 + \dfrac{\mu_{\text{уст}}}{3} \dfrac{b_{\text{ср}}}{h_{\text{ср}}} &, \dfrac{b_{\text{ср}}}{h_{\text{ср}}} < \dfrac{0.465}{\mu_{\text{уст}}}
\end{cases}
\]

\[n_{\sigma}' = \begin{cases}
\vspace{2ex}
1 + \dfrac{l}{4 h_{\text{ср}}} &, \dfrac{l}{h_{\text{ср}}} > 4\\
\vspace{2ex}
\dfrac{2 h_{\text{н}}}{\triangle h \delta} \left[ \left( \dfrac{h_{\text{н}}}{h_{\text{1}}^{\text{пр}}} \right)^{\delta} - 1\right] &, 2 < \dfrac{l}{h_{\text{ср}}} < 4\\
1 + \dfrac{l}{6 h_{\text{ср}}}&, 1 < \dfrac{l}{h_{\text{ср}}} < 2
\end{cases}
\]
При этом:
\[ \dfrac{h_{\text{н}}}{h_1^{\text{пр}}} = \left( \dfrac{1 + \sqrt{1 + (\delta^2 - 1) \cdot \left( \dfrac{h_0^{\text{пр}}}{h_1^{\text{пр}}} \right)^{\delta}}}{\delta + 1} \right)^{\frac{1}{\delta}}
\]

\[ \delta = \dfrac{2 \mu_{\text{уст}} l}{\triangle h^{\text{пр}}} \]

\[ n_{\sigma}'' = \begin{cases}
1 &, \dfrac{l}{h_{\text{ср}}} > 1\\
\left( \dfrac{l}{h_{\text{ср}}} \right)^{-0.4} &, \dfrac{l}{h_{\text{ср}}} < 1
\end{cases}
\]

\[ n_{\sigma}''' = 1, \text{так как натяжение отсутствует} \]

\[ n_{\text{в}} = \dfrac{1 + \dfrac{3 b_{\text{ср}} - l}{6 b_{\text{ср}}} \cdot \mu \frac{l}{h_{\text{ср}}}}{1 + \dfrac{\mu}{2} \frac{l}{h_{\text{ср}}}}
\]

\[ n_{\text{к}} = \dfrac{1.155 \left( 1 + \dfrac{2 \mu_{\text{уст}} \alpha l}{3 h_{\text{ср}} \pi} \right)}{\gamma \left( 1 + 
	\dfrac{\mu}{3} \dfrac{l}{h_{\text{ср}}} \right)} \]

Тогда усилия при прокатке:

\begin{equation}
P = p_{\text{ср}} F_{\text{к}}
\end{equation}

Где \[ F_{\text{к}} = b_{\text{ср}} l \]
...
\begin{equation}
m = \dfrac{\mu_{\text{уст}} l}{h_{\text{ср}}^{\text{пр}}}
\end{equation}
...
\begin{equation}
T_{\text{вых}} = T_{\text{вх}}^i + \triangle T_{\text{д}}^i - \triangle T_{\text{в}}^i - \triangle T_{\text{л}}^i - \triangle T_{\text{к}}^i
\end{equation}

Где \( \triangle T_{\text{д}}^i \) --- повышение температуры полосы за счет пластической деформации,
\begin{equation}
\triangle T_{\text{д}} = \dfrac{p_{\text{ср}} \cdot \ln\left( \dfrac{h_{0}}{h_1} \right) \eta}{c \rho}
\end{equation}

Здесь $c = 548 \dfrac{\text{Дж}}{\text{кг} \cdot ^{\circ}C} $~--- теплоёмкость стали, $ \rho = 7900 \dfrac{\text{кг}}{\text{м}^3}$~---
плотность стали при заданной температуре, $\eta = 0.8$~--- потери тепла в окружающую среду.

$\triangle T_{\text{в}} $~--- охлаждение полосы за счёт контакта с валками,
\begin{equation}
\triangle T_{\text{в}} = \dfrac{4.87}{h_0 + h_1} \left( T_{\text{вх}} - T_{\text{цв}} \right) \sqrt{\dfrac{2 l h_0}{10^3 \left(h_0 + h_1 \right) v}}
\end{equation}

Здесь $T_{\text{цв}}$~--- температура центра валков. Примем $T_{\text{цв}} = 50^{\circ}C$.

$\triangle T_{\text{л}}$~--- охлаждение полосы за счет лучеиспускания при перемещении ее между клетям,
\begin{equation}
\triangle T_{\text{л}} = k_{\text{ст}} \dfrac{T_i^4}{h_1^{\text{пр}}} \tau_{\text{мк}} \cdot 10^{-12}
\end{equation}

Здесь $k_{\text{ст}} = 17.5$~--- коэффициент, зависящий от марки сталей, $T_{i} = T_{\text{вх}} + \triangle T_{\text{д}} - \triangle T_{\text{в}}$~---
Температура полосы непосредственно на выходе из валков после $i$--го прохода, $ ^{\circ}K $.

$\tau_{\text{мк}}$~--- время прохождения полосы в межклетевом промежутке. 
...
Время движения по обводному аппарату составит:
 \[ \tau_{OA} = \dfrac{l_{OA}}{v_{\text{вых}}} \]
 
Время нахождения оставшейся части полосы между клетями:
\[ \tau_{\text{хв} i} = \dfrac{l_i - l_{OA}}{v_{\text{вх} i - 1}} \] 

$\triangle T_{\text{к}}$~--- охлаждение полосы за счёт конвекции, 
\begin{equation}
\triangle T_{\text{к}} = 0.03 \triangle T_{\text{л}}
\end{equation}
...
\hline
$\sigma_{\text{ф}}$, МПа & 181.616 & 183.925 & 190.953 & 210.884\\
\hline
$\mu_{\text{уст}}$ & 0.331 & 0.334 & 0.333 & 0.34\\
\hline
$\triangle b$, мм & 7.217 & 2.27 & 2.186 & 5.25\\
\hline
$b_{\text{ср}}$, мм & 41.608 & 29.417 & 31.645 & 23.565\\
\hline
$p_{\text{ср}}$, МПа & 231.272 & 226.629 & 244.057 & 259.438\\
\hline
$P_{\text{пр}}$, кН & 349.507 & 251.532 & 242.35 & 211.942\\
\hline
$M_{\text{пр}}$, кН$\cdot$мм & 8.096 & 8.253 & 10.842 & 13.008\\
\hline
$l_{\text{вых}}$, мм & 13187.703 & 17803.399 & 24052.392 & 29584.442\\
\hline
$T_{\text{вых}}$, $^{\circ}C$ & 1013.3 & 1004.318 & 981.907 & 964.71\\
\hline
$\triangle T_{\text{д}}$, $^{\circ}C$ & 16.243 & 15.801 & 16.692 & 20.65\\
\hline
$\triangle T_{\text{в}}$, $^{\circ}C$ & 10.641 & 9.87 & 12.788 & 12.613\\
\hline
$\triangle T_{\text{л}}$, $^{\circ}C$ & 11.944 & 14.479 & 25.548 & 24.499\\
\hline
$\triangle T_{\text{к}}$, $^{\circ}C$ & 0.358 & 0.434 & 0.766 & 0.735\\
\hline
$\tau$ & 4.898 & 6.639 & 8.372 & 8.641\\
\hline
$v_{\text{вх}}$ & 2.735 & 2.477 & 2.536 & 2.783\\
\hline
$v_{\text{вых}}$ & 3.367 & 3.343 & 3.427 & 3.424\\
\hline
\end{tabular}
\label{tab:rez:rasch}
\end{table}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/delta_h}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/epsilon}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/p_sr}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/P_pr}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{pic/M}
...
, caliber_4.params[r'$T_{\text{вых}}$, $^{\circ}C$'], l
_mk, n, lambda_3, caliber_4.params[r'$l_{\text{вых}}$, 
мм'], caliber_2.v_vh)
22. caliber_3.computing()
23. caliber_2 = LetStripStand(F_3, F_2, B_3, B_2, D_val
, caliber_3.params[r'$T_{\text{вых}}$, $^{\circ}C$'], l
_mk, n, lambda_2, caliber_3.params[r'$l_{\text{вых}}$, 
мм'], caliber_1.v_vh)
24. caliber_2.computing()
25. caliber_1 = LetStripStand(F_2, F_1, B_2_sht, B_1, D
_val, caliber_2.params[r'$T_{\text{вых}}$, $^{\circ}C$'
], l_mk, n, lambda_1, caliber_2.params[r'$l_{\text{вых}
}$, мм'], caliber_1.v)
...
28.         params[r'$\sigma_{\text{ф}}$, МПа'] = 3250 
...
self.b_0, params['$l$, мм'], params[r'$\mu_{\text{уст}}
$'], params[r'$\sigma_{\text{ф}}$, МПа'])
92.         params[r'$p_{\text{ср}}$, МПа'] = p_mid
93.         f_k = p_mid * (self.b_1 + self.b_0) / 2 * p
arams['$l$, мм'] # Это в ньютонах
94.         params[r'$P_{\text{пр}}$, кН'] = f_k / 1000
# это в килоньютонах
...
rams[r'$\mu_{\text{уст}}$'], params['$l$, мм'], self.h_
1, self.h_0, p_mid)
111.         params['$M_{\\text{пр}}$, кН$\\cdot$мм'] =
mp
112.         
113.         v_vih = self.v * self.lambd
114.         #params[r'v_{\text{вых}}'] = v_vih
115.         params[r'$l_{\text{вых}}$, мм'] = self.l_0
* self.lambd
116.         
...
_d, t_v, t_l, t_k
138.         
139.         params[r'$T_{\text{вых}}$, $^{\circ}C$'], 
t_d, t_v, t_l, t_k = t_vih(self.t_vh, p_mid, self.h_0, 
self.h_1, self.v, params['$l$, мм'], self.a, params[r'$
l_{\text{вых}}$, мм'], self.v_vh_next)
140.         
141.         params[r'$\triangle T_{\text{д}}$, $^{\cir
c}C$'] = t_d
142.         params[r'$\triangle T_{\text{в}}$, $^{\cir
c}C$'] = t_v
143.         params[r'$\triangle T_{\text{л}}$, $^{\cir
c}C$'] = t_l
144.         params[r'$\triangle T_{\text{к}}$, $^{\cir
c}C$'] = t_k
145.         
146.         params['$\\tau$'] = self.a / (self.v * 100
0) + (params[r'$l_{\text{вых}}$, мм']-self.a) / (self.v
_vh_next * 1000)
147.         
...
168.         super().computing()
169.         self.params['$v_{\\text{вх}}$'] = self.v_v
h
170.         self.params['$v_{\\text{вых}}$'] = self.v
171. 
